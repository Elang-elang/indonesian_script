...
// sha3: f0ee535d4027f268abee3a68e1139eed147306602693ff1e03c46f287c13657c
use std::str::FromStr;
use super::lib::variable::Value;
use super::lib::utils::extract_int;
...
mod __parse__Expr {
    ...
    use std::str::FromStr;
    use super::super::lib::variable::Value;
    use super::super::lib::utils::extract_int;
    #[allow(unused_extern_crates)]
    extern crate lalrpop_util as __lalrpop_util;
    #[allow(unused_imports)]
    use self::__lalrpop_util::state_machine as __state_machine;
    ...
    impl ExprParser {
        ...
        >(
            &self,
            input: &'input str,
        ) -> Result<Value, __lalrpop_util::ParseError<usize, Token<'input>, &'static str>>
        {
    ...
    >(
        ...
        _: core::marker::PhantomData<(&'input ())>,
    ) -> Option<Result<Value,__lalrpop_util::ParseError<usize, Token<'input>, &'static str>>>
    {
...
>(
    input: &'input str,
    (_, l, _): (usize, Value, usize),
    (_, _, _): (usize, &'input str, usize),
    (_, r, _): (usize, Value, usize),
) -> Value
{
    Value::Angka(extract_int(l) + extract_int(r))
}
...
{
    Value::Angka(i64::from_str(__0).unwrap())
}
